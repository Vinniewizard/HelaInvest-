    ...
    <div className="min-h-screen flex flex-col font-sans bg-gradient-to-br from-[#e8f5e9] via-[#f1f8e9] to-[#fffde7]">
      ...
      <div className="w-full h-20 px-8 flex items-center justify-between bg-white shadow-sm">
        ...
        <div className="flex items-center gap-4">
          <button onClick={onNavigateToLogin} className="text-sm font-semibold text-slate-800 hover:text-[#006B4A] transition-colors cursor-pointer">Login</button>
          <button 
      ...
      {/* Main Content */}
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12 mb-10">
        <div className="w-full max-w-[480px] bg-white rounded-2xl shadow-xl overflow-hidden p-8 sm:p-10 relative">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
               <div className="space-y-1.5">
                  <label className="block text-sm font-semibold text-slate-600">M-Pesa Phone *</label>
                  <input
                    type="tel"
                    required
                    value={phone}
               ...
               <div className="space-y-1.5">
                  <label className="block text-sm font-semibold text-slate-600">Invite Code</label>
                  <input
                    type="text"
                    value={inviteCode}
