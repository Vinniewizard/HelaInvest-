...
import { Users, Copy, CheckCircle2, Link as LinkIcon, Gift, TrendingUp as TrendingUpIcon } from "lucide-react";
...
export default function Referrals({ user, referrals, onRefresh }: ReferralsProps) {
